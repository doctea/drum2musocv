...
extern uint8_t cc_value_sync_modifier;  // initial global clock sync modifier -- number of real ticks per 24 pseudoticks ?
extern envelope_state envelopes[NUM_ENVELOPES_EXTENDED];
