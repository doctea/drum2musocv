...
unsigned long last_clock_ticked;
...
void fire_trigger(byte trigger, byte velocity, bool internal) {
...
void douse_trigger(byte trigger, byte velocity, bool internal, bool tied) {
  unsigned long trigger_time = millis();
...
void douse_all_triggers(bool internal) {
