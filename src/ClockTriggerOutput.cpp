...
const byte clock_map[] = { 4, 2, 3, 10 };  // this is the one, for some reason?  doesn't make sense, have i got my pins swapped somewhere?
//const static byte clock_map[] = { 1, 2, 6, 11 };
//const static byte clock_map[] = { 1, 2, 6, 10 };
//const static byte clock_map[] = { 2, 6, 4, 10 };

int should_send_clock[4] = { 0, 0, 0, 0 }; // keep track of whether an output should be active + how long its been HIGH

bool clock_on = false;
unsigned long last_clock_trigger_ticked;
unsigned long last_beat_clock_millis;
